...
console.log(resultado2010);
console.log(resultado2015);
console.log(resultado2020);
...
// Utilizamos variables booleanas para representar si la media de cada año > 30ºC
